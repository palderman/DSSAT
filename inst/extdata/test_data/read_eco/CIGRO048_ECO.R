...
"MATURITY GROUP 0", "DEFAULT        0"), MG = c("00", "00", "00"
), TM = c("01", "01", "01"), THVAR = c(0, 0, 0), `PL-EM` = c(3, 
3, 3), `EM-V1` = c(3, 3, 3), `V1-JU` = c(0, 0, 0), `JU-R0` = c("05.0", 
"05.0", "05.0"), PM06 = c(0, 0, 0), PM09 = c(0.35, 0.35, 0.35
), LNGSH = c(13, 10, 13), `R7-R8` = c(12, 12, 12), `FL-VS` = c(0.5, 
0.5, 0.5), TRIFL = c(0.72, 0.72, 0.72), RWDTH = c(1, 1, 1), RHGHT = c(1, 
...
LNGSH = "%6.0f", `R7-R8` = "%6.0f", `FL-VS` = "%6.1f", TRIFL = "%6.2f", 
RWDTH = "%6.0f", RHGHT = "%6.0f", R1PPO = "%6.3f", OPTBI = "%6.0f", 
SLOBI = "%6.3f"), first_line = "*CHIA ECOTYPE COEFFICIENTS: CRGRO048 MODEL", comments = c("", 

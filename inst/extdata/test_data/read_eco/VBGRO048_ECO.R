structure(list(`ECO#` = c("VB0001", "VB0002", "DFAULT"), ECONAME = c("MUCUNA GENERAL", 
"MUCUNA Small", "DEFAULT"), MG = c("08", "08", "08"), TM = c("01", 
"01", "01"), `PP-SS` = c(0, 0, 0), `PL-EM` = c(3, 3.8, 3), `EM-V1` = c(4, 
5, 4), `V1-JU` = c(0, 0, 0), `JU-R0` = c("05.0", "05.0", "05.0"
), PM06 = c(0, 0, 0), PM09 = c(0.35, 0.35, 0.35), LNHSH = c(25, 
12, 25), `R7-R8` = c(21, 12, 21), `FL-VS` = c(90, 12, 90), TRIFL = c(0.3, 
0.3, 0.3), RWDTH = c(1, 1, 1), RHGHT = c(1, 0.8, 1), R1PPO = c(0.549, 
0.549, 0.549), OPTBI = c(20, 20, 20), SLOBI = c(0, 0, 0)), class = c("DSSAT_tbl", 
...
`FL-VS` = "%6.0f", TRIFL = "%6.1f", RWDTH = "%6.0f", RHGHT = "%6.1f", 
R1PPO = "%6.3f", OPTBI = "%6.0f", SLOBI = "%6.0f"), first_line = "*VELVETBEAN ECOTYPE COEFFICIENTS: CRGRO048 MODEL", comments = c("", 

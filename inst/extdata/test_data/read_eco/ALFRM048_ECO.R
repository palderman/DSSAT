...
), MG = c("00", "00", "00", "00", "00", "00", "00"), TM = c("01", 
"01", "01", "01", "01", "01", "01"), THVAR = c(1, 1, 1, 1, 1, 
1, 1), `PL-EM` = c(0, 0, 0, 0, 0, 0, 0), `EM-V1` = c(0, 0, 0, 
0, 0, 0, 0), `V1-JU` = c(0, 0, 0, 0, 0, 0, 0), `JU-R0` = c(9999, 
9999, 9999, 9999, 9999, 9999, 9999), PM06 = c(0, 0, 0, 0, 0, 
0, 0), PM09 = c(0.75, 0.75, 0.75, 0.75, 0.75, 0.75, 0.75), LNGSH = c(10, 
10, 10, 10, 10, 10, 10), `R7-R8` = c(9999, 9999, 9999, 9999, 
9999, 9999, 9999), `FL-VS` = c(9999, 9999, 9999, 9999, 9999, 
9999, 9999), TRIFL = c(0.24, 0.24, 0.24, 0.24, 0.24, 0.2, 0.2
), RWDTH = c(1, 1, 1, 1, 1, 1, 1), RHGHT = c(1, 1, 1, 1, 1, 1, 
1), R1PPO = c(0, 0, 0, 0, 0, 0, 0), OPTBI = c(0, 0, 0, 0, 0, 
0, 0), SLOBI = c(0, 0, 0, 0, 0, 0, 0), RDRMT = c(0.421, 0.5, 
0.32, 0.14, 0.421, 0.421, 0.5), RDRMG = c(1, 1, 1, 1, 1, 1, 1
), RDRMM = c(0.85, 0.85, 0.85, 0.85, 0.65, 0.95, 0.95), RCHDP = c(1, 
1, 1, 1, 1, 1, 1)), class = c("DSSAT_tbl", "tbl_df", "tbl", "data.frame"
), row.names = c(NA, -7L), v_fmt = c(`ECO#` = "%-7s", ECONAME = "%-18s", 
MG = "%2s", TM = "%3s", THVAR = "%6.0f", `PL-EM` = "%6.0f", `EM-V1` = "%6.0f", 
`V1-JU` = "%6.0f", `JU-R0` = "%6.0f", PM06 = "%6.0f", PM09 = "%6.2f", 
LNGSH = "%6.0f", `R7-R8` = "%6.0f", `FL-VS` = "%6.0f", TRIFL = "%6.2f", 
RWDTH = "%6.0f", RHGHT = "%6.0f", R1PPO = "%6.0f", OPTBI = "%6.0f", 
SLOBI = "%6.0f", RDRMT = "%6.3f", RDRMG = "%6.0f", RDRMM = "%6.2f", 
RCHDP = "%6.0f"), first_line = "*ALFALFA ECOTYPE COEFFICIENTS: PRFRM048 MODEL", comments = c("", 

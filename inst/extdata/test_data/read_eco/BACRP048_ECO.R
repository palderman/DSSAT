...
1.6, 1.3, 1, 1, 1), SLAS = c(100, 400, 400, 300, 300, 400), LSENI = c(0.1, 
2.5, 1.5, 1, 1, 0.6), LSPHS = c(5, 8.5, 8, 8.7, 8.7, 8.7), LSPHE = c(5, 
9.5, 9.2, 9.3, 9.3, 9.3), `TIL#S` = c(2, 5, 4, 5, 5, 4.5), TIPHE = c(2, 
5, 3, 3, 3, 3), TIFAC = c(0.1, 1, 1, 0.5, 0.5, 1), TDPHS = c(1.5, 
3.5, 3, 3, 3, 3), TDPHE = c(4.5, 8, 7, 8, 8, 8), TDFAC = c(0.1, 
15, 5, 3, 5, 5), TDSF = c(0, 1, 1, 0, 0, 0), RDGS = c(1, 5, 3, 
3, 3, 3), HTSTD = c(50, 150, 100, 100, 100, 100), AWNS = c(0, 
10, 5, 5, 5, 5), KCAN = c(0.65, 0.95, 0.85, 0.85, 0.85, 0.85), 
    `RS%A` = c(5, 30, 15, 30, 30, 30), `GN%S` = c(1, 3, 2, 2, 
    2, 2), `GN%MN` = c(0.5, 2.5, 1.5, 1, 1, 1), `GM%H` = c(0, 
    25, 15, 15, 15, 15), TKFH = c(-10, -30, -15, -10, -10, -20
    ), SSPHS = c(5, 8.5, 8, 8.7, 8.7, 8.7), SSPHE = c(6, 9.5, 
    9.3, 9.3, 9.3, 9.3), GWTAF = c(0, 0.7, 0.3, 0.3, 0.3, 0.3
    ), GWTAT = c(1000, 7000, 4000, 4000, 4000, 4000), `G#RF` = c(0, 
    0.05, 0, 0.03, 0.03, 0.03), RTNUP = c(0.001, 0.01, 0.006, 
    0.006, 0.006, 0.006), NUPNF = c(0.1, 2, 1, 0.4, 0.4, 1), 
    NUPWF = c(0, 2, 1, 1, 1, 1)), class = c("DSSAT_tbl", "tbl_df", 
"tbl", "data.frame"), row.names = c(NA, -6L), v_fmt = c(`ECO#` = "%-7s", 

...
"MUCUNA Small", "DEFAULT"), MG = c(8L, 8L, 8L), TM = c(1L, 1L, 
1L), `PP-SS` = c(0, 0, 0), `PL-EM` = c(3, 3.8, 3), `EM-V1` = c(4, 
5, 4), `V1-JU` = c(0, 0, 0), `JU-R0` = c(5, 5, 5), PM06 = c(0, 
0, 0), PM09 = c(0.35, 0.35, 0.35), LNHSH = c(25, 12, 25), `R7-R8` = c(21, 
12, 21), `FL-VS` = c(90, 12, 90), TRIFL = c(0.3, 0.3, 0.3), RWDTH = c(1, 
1, 1), RHGHT = c(1, 0.8, 1), R1PPO = c(0.549, 0.549, 0.549), 
    OPTBI = c(20, 20, 20), SLOBI = c(0, 0, 0)), class = c("DSSAT_tbl", 

...
), MG = c(1L, 1L, 1L, 1L), TM = c(1L, 1L, 1L, 1L), `PP-SS` = c(0, 
0, 0, 0), `PL-EM` = c(5, 5, 5, 5), `EM-V1` = c(10, 10, 10, 20
), `V1-JU` = c(24, 24, 0, 0), `JU-R0` = c(5, 5, 5, 5), PM06 = c(0, 
0, 0, 0), PM09 = c(0.75, 0.75, 0.75, 0.75), LNHSH = c(35, 35, 
35, 35), `R7-R8` = c(0, 0, 15, 0), `FL-VS` = c(53, 53, 53, 18
), TRIFL = c(0.35, 0.35, 0.35, 0.52), RWDTH = c(1, 1, 1, 1), 
    RHGHT = c(1, 1, 1, 1), R1PPO = c(0, 0, 0, 0), OPTBI = c(0, 
    0, 0, 0), SLOBI = c(0, 0, 0, 0)), class = c("DSSAT_tbl", 
...
R1PPO = "%6.0f", OPTBI = "%6.0f", SLOBI = "%6.0f"), first_line = "*PEPPER ECOTYPE COEFFICIENTS: CRGRO048 MODEL", comments = c(" PARAM   DEFINITIONS", 

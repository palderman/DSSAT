structure(list(`ECO#` = "GG0009", ECONAME = "Panicum", MG = 0L, 
...
OPTBI = "%6.0f", SLOBI = "%6.0f", RDRMT = "%6.2f", RDRMG = "%6.0f", 
RDRMM = "%6.3f", RCHDP = "%6.0f"), first_line = "*GUINEAGRASS ECOTYPE COEFFICIENTS (27)                                                                                                                                                                        ", comments = c("Guineagrass - Panicum maximum", 

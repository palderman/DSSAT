structure(list(`ECO#` = c("BR0001", "DFAULT"), ECONAME = c("DEFAULT BRACHI", 
"DEFAULT ECOTYPE"), MG = c(0L, 0L), TM = c(1L, 1L), `PP-SS` = c(1, 
1), `PL-EM` = c(3, 0), `EM-V1` = c(6, 0), `V1-JU` = c(9999, 9999
), `JU-R0` = c(9999, 9999), PM06 = c(0, 0), PM09 = c(0.75, 0.75
), LNHSH = c(10, 10), `R7-R8` = c(9999, 9999), `FL-VS` = c(9999, 
9999), TRIFL = c(0.1, 0.1), RWDTH = c(1, 1), RHGHT = c(1, 1), 
...
R1PPO = "%6.0f", OPTBI = "%6.0f", SLOBI = "%6.0f"), first_line = "*BRACHIARIA DECUMBENS ECOTYPE COEFFICIENTS: CRGRO08 MODEL", comments = c("", 

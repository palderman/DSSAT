structure(list(`ECO#` = "G00002", ECONAME = "TIFTON 85 BERMUDA", 
    MG = 0L, TM = 1L, THVAR = 1, `PL-EM` = 0, `EM-V1` = 0, `V1-JU` = 0, 
    `JU-R0` = 9999, PM06 = 0, PM09 = 0.75, LNGSH = 10, `R7-R8` = 9999, 
    `FL-VS` = 9999, TRIFL = 0.15, RWDTH = 1, RHGHT = 1, R1PPO = 0, 
    OPTBI = 0, SLOBI = 0, RDRMT = 0.538, RDRMG = 1, RDRMM = 0.867, 
...
RDRMM = "%6.3f", RCHDP = "%6.0f"), first_line = "*Bermuda Grass ECOTYPE COEFFICIENTS: PRFRM048 MODEL", comments = c(" Tifton 85 - Diego Pequeno", 

...
"MATURITY GROUP 0", "DEFAULT"), MG = c(0L, 0L, 0L), TM = c(1L, 
1L, 1L), THVAR = c(0, 0, 0), `PL-EM` = c(3.2, 3.2, 3.2), `EM-V1` = c(2, 
2, 2), `V1-JU` = c(0, 0, 0), `JU-R0` = c(5, 5, 5), PM06 = c(0, 
0, 0), PM09 = c(0.35, 0.35, 0.35), LNGSH = c(10, 10, 10), `R7-R8` = c(12, 
12, 12), `FL-VS` = c(20, 20, 20), TRIFL = c(0.9, 1.2, 0.9), RWDTH = c(1, 
0.8, 1), RHGHT = c(1, 0.8, 1), R1PPO = c(0.189, 0.189, 0.189), 
    OPTBI = c(18, 18, 18), SLOBI = c(0.028, 0.028, 0.028)), class = c("DSSAT_tbl", 
...
`FL-VS` = "%6.0f", TRIFL = "%6.1f", RWDTH = "%6.1f", RHGHT = "%6.1f", 
R1PPO = "%6.3f", OPTBI = "%6.0f", SLOBI = "%6.3f"), first_line = "*QUINOA ECOTYPE COEFFICIENTS: CRGRO048 MODEL", comments = c("", 

...
"DEFAULT PIGEONPEA", "INDIA ICPL88039"), MG = c(3L, 3L, 3L), 
    TM = c(1L, 1L, 1L), THVAR = c(0, 0, 0), `PL-EM` = c(5.02, 
    5.02, 4.88), `EM-V1` = c(6, 6, 6), `V1-JU` = c(0, 0, 0), 
    `JU-R0` = c(5, 5, 5), PM06 = c(0, 0, 0), PM09 = c(0.35, 0.35, 
    0.35), LNGSH = c(10, 10, 10), `R7-R8` = c(8.43, 8.43, 22.51
    ), `FL-VS` = c(11.26, 11.26, 12.03), TRIFL = c(0.8, 0.8, 
    0.8), RWDTH = c(1, 1, 1), RHGHT = c(1, 1, 1), R1PPO = c(0.435, 
    0.435, 0.35), OPTBI = c(18, 18, 18), SLOBI = c(0.028, 0.028, 
    0.028)), class = c("DSSAT_tbl", "tbl_df", "tbl", "data.frame"
), row.names = c(NA, -3L), v_fmt = c(`ECO#` = "%-7s", ECONAME = "%-18s", 
MG = "%2.0f", TM = "%3.0f", THVAR = "%6.0f", `PL-EM` = "%6.2f", 

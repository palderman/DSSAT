...
"GP 3774"), MG = c(2L, 2L, 2L, 2L, 2L), TM = c(1L, 1L, 1L, 1L, 
1L), THVAR = c(0, 0, 0, 0, 0), `PL-EM` = c(4, 4, 4, 4, 4), `EM-V1` = c(4, 
4, 4, 4, 4), `V1-JU` = c(0, 0, 0, 0, 0), `JU-R0` = c(0, 0, 0, 
0, 0), PM06 = c(0, 0, 0, 0, 0), PM09 = c(0.9, 0.9, 0.9, 0.9, 
0.9), LNGSH = c(10, 12, 6, 8, 8), `R7-R8` = c(10, 10, 10, 10, 
10), `FL-VS` = c(75, 65, 75, 40, 75), TRIFL = c(0.2, 0.25, 0.2, 
0.2, 0.2), RWDTH = c(0.8, 1, 1, 1, 0.85), RHGHT = c(0.85, 0.9, 
1, 0.9, 0.95), R1PPO = c(0.001, 0.001, 0.001, 0.001, 0.001), 
...
TRIFL = "%6.2f", RWDTH = "%6.2f", RHGHT = "%6.2f", R1PPO = "%6.3f", 
OPTBI = "%6.0f", SLOBI = "%6.3f", KCAN = "%6f"), first_line = "*COTTON ECOTYPE COEFFICIENTS - CRGRO048 MODEL", comments = c("", 

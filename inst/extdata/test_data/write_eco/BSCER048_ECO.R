structure(list(ECO = c("IB0001", "IB0002", "DFAULT", "IHSTUT"
), ECONAME = c("GENERIC 1", "GENERIC 2", "DEFAULT", "Betaseed, Germany"
), TBASE = c(3, 3, 3, 3), TOPT = c(27, 27, 32, 27), ROPT = c(27, 
27, 27, 27), P20 = c(12.5, 12.5, 12.5, 12.5), DJTI = c(4, 4, 
4, 4), GDDE = c(6, 5.9, 6, 6), DSGFT = c(170, 170, 180, 170), 
    RUE = c(3.7, 3, 3.8, 3.8), KCAN = c(0.75, 0.75, 0.85, 0.7
    ), TSEN = c(NA_real_, NA_real_, NA_real_, NA_real_), CDAY = c(NA_real_, 
    NA_real_, NA_real_, NA_real_)), class = c("DSSAT_tbl", "tbl_df", 
"tbl", "data.frame"), row.names = c(NA, -4L), v_fmt = c(ECO = "%-7s", 
ECONAME = "%-18s", TBASE = "%5.0f", TOPT = "%6.0f", ROPT = "%5.0f", 
P20 = "%6.1f", DJTI = "%6.0f", GDDE = "%6.1f", DSGFT = "%7.0f", 
RUE = "%5.1f", KCAN = "%7.2f", TSEN = "%6f", CDAY = "%6f"), first_line = "*Sugarbeet ECOTYPE COEFFICIENTS: BSCER048 MODEL", comments = c("", 

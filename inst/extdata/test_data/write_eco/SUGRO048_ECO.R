...
"DEFAULT"), MG = c(7L, 7L), TM = c(1L, 1L), THVAR = c(0, 0), 
    `PL-EM` = c(4.8, 4.8), `EM-V1` = c(1, 1), `V1-JU` = c(0, 
    0), `JU-R0` = c(5, 5), PM06 = c(0, 0), PM09 = c(0.35, 0.35
    ), LNGSH = c(8, 8), `R7-R8` = c(4, 4), `FL-VS` = c(9.5, 9.5
    ), TRIFL = c(0.8, 0.8), RWDTH = c(0.6, 0.6), RHGHT = c(1.2, 
    1.2), R1PPO = c(0, 0), OPTBI = c(0, 0), SLOBI = c(0, 0)), class = c("DSSAT_tbl", 
...
`FL-VS` = "%6.1f", TRIFL = "%6.1f", RWDTH = "%6.1f", RHGHT = "%6.1f", 
R1PPO = "%6.0f", OPTBI = "%6.0f", SLOBI = "%6.0f"), first_line = "*SUNFLOWER  ECOTYPE COEFFICIENTS: CRGRO048 MODEL       ", comments = c("", 

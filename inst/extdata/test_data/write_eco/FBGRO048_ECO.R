...
"170d seas 1.2g/s", "170d seas 1.2g/s", "DEFAULT"), MG = c(2L, 
2L, 2L, 2L, 2L), TM = c(2L, 2L, 2L, 2L, 2L), `PP-SS` = c(0, 0, 
0, 0, 0), `PL-EM` = c(4.8, 6, 6, 6, 6), `EM-V1` = c(2.8, 4, 4, 
4, 4), `V1-JU` = c(0, 0, 0, 0, 0), `JU-R0` = c(3.5, 5, 5, 5, 
5), PM06 = c(0, 0, 0, 0, 0), PM09 = c(0.58, 0.58, 0.58, 0.58, 
0.58), LNHSH = c(12, 14, 17.5, 17.5, 14), `R7-R8` = c(12, 12, 
12, 12, 12), `FL-VS` = c(28, 33, 44, 44, 33), TRIFL = c(0.35, 
0.35, 0.35, 0.35, 0.35), RWDTH = c(1, 1, 1, 1.1, 1), RHGHT = c(0.8, 
1, 1.1, 1.16, 1), R1PPO = c(0, 0, 0, 0, 0), OPTBI = c(0, 0, 0, 
0, 0), SLOBI = c(0, 0, 0, 0, 0)), class = c("DSSAT_tbl", "tbl_df", 
"tbl", "data.frame"), row.names = c(NA, -5L), v_fmt = c(`ECO#` = "%-7s", 
ECONAME = "%-18s", MG = "%2.0f", TM = "%3.0f", `PP-SS` = "%6.0f", 
`PL-EM` = "%6.1f", `EM-V1` = "%6.1f", `V1-JU` = "%6.0f", `JU-R0` = "%6.1f", 
PM06 = "%6.0f", PM09 = "%6.2f", LNHSH = "%6.1f", `R7-R8` = "%6.0f", 
`FL-VS` = "%6.0f", TRIFL = "%6.2f", RWDTH = "%6.1f", RHGHT = "%6.2f", 
R1PPO = "%6.0f", OPTBI = "%6.0f", SLOBI = "%6.0f"), first_line = "*FABA BEAN ECOTYPE COEFFICIENTS: CRGRO048 MODEL", comments = c("", 

structure(list(`ECO#` = c("MESIND", "MESDET", "ANDIND", "ANDDET", 
"MEXHIL", "EMBRAP", "DFAULT"), ECONAME = c("MESO AMER T 2-4", 
"MESO AMER TYPE 1", "ANDEAN TYPE 2-4", "ANDEAN TYPE 1", "Mex Highland Ind", 
"EMBRAPA", "DEFAULT ECOTYPE"), MG = c("01", "01", "02", "02", 
"01", "01", "01"), TM = c("01", "01", "02", "02", "01", "01", 
"01"), THVAR = c(0, 0, 0, 0, 0, 0, 1), `PL-EM` = c(3, 3, 4, 4, 
3.5, 3, 4), `EM-V1` = c(3, 3, 3, 3, 3, 5, 5), `V1-JU` = c(0, 
0, 0, 0, 0, 0, 0), `JU-R0` = c(5, 5, 5, 5, 5, 5, 5), PM06 = c(0, 
0, 0, 0, 0, 0, 0), PM09 = c(0.55, 0.55, 0.55, 0.55, 0.55, 0.75, 
0.5), LNGSH = c(8, 8, 8, 8, 8, 8, 8), `R7-R8` = c(9, 7, 9, 7, 
9, 10, 10), `FL-VS` = c(11, 0, 11, 0, 11, 13, 13), TRIFL = c(0.35, 
0.35, 0.35, 0.35, 0.35, 0.35, 0.35), RWDTH = c(1, 1, 1, 1, 1, 
1, 1), RHGHT = c(1, 1, 1, 1, 1, 1, 1), R1PPO = c(0, 0, 0, 0, 
0, 0, 0), OPTBI = c(0, 0, 0, 0, 0, 0, 0), SLOBI = c(0, 0, 0, 
0, 0, 0, 0)), class = c("DSSAT_tbl", "tbl_df", "tbl", "data.frame"
...
SLOBI = "%6.0f"), first_line = "*DRYBEAN ECOTYPE COEFFICIENTS: CRGRO048 MODEL", comments = c("", 

...
0), `PL-EM` = c(6, 6), `EM-V1` = c(22, 22), `V1-JU` = c(0, 0), 
    `JU-R0` = c("05.0", "05.0"), PM06 = c(0.55, 0.55), PM09 = c(0.75, 
    0.75), LNGSH = c(39, 39), `R7-R8` = c(0, 0), `FL-VS` = c(24.5, 
    24.5), TRIFL = c(0.45, 0.45), RWDTH = c(1, 1), RHGHT = c(1, 
    1), R1PPO = c(0, 0), OPTBI = c("00.0", "00.0"), SLOBI = c(0, 
    0)), class = c("DSSAT_tbl", "tbl_df", "tbl", "data.frame"
), row.names = c(NA, -2L), v_fmt = c(`ECO#` = "%-7s", ECONAME = "%-18s", 
MG = "%2s", TM = "%3s", THVAR = "%6.0f", `PL-EM` = "%6.0f", `EM-V1` = "%6.0f", 
`V1-JU` = "%6.0f", `JU-R0` = "%6s", PM06 = "%6.2f", PM09 = "%6.2f", 
LNGSH = "%6.0f", `R7-R8` = "%6.0f", `FL-VS` = "%6.1f", TRIFL = "%6.2f", 
RWDTH = "%6.0f", RHGHT = "%6.0f", R1PPO = "%6.0f", OPTBI = "%6s", 
SLOBI = "%6.0f"), first_line = "*TOMATO ECOTYPE COEFFICIENTS: CRGRO048 MODEL", comments = c("", 

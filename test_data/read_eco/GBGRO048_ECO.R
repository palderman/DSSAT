structure(list(`ECO#` = "SNAPBN", ECONAME = "X-ANDEAN TYPE", 
    MG = "02", TM = "02", THVAR = 0, `PL-EM` = 4, `EM-V1` = 3, 
    `V1-JU` = 0, `JU-R0` = 5, PM06 = 0, PM09 = 0.55, LNGSH = 8, 
    `R7-R8` = 7, `FL-VS` = 1, TRIFL = 0.33, RWDTH = 1.1, RHGHT = 1, 
    R1PPO = 0, OPTBI = 0, SLOBI = 0), class = c("DSSAT_tbl", 
...
TRIFL = "%6.2f", RWDTH = "%6.1f", RHGHT = "%6.0f", R1PPO = "%6.0f", 
OPTBI = "%6.0f", SLOBI = "%6.0f"), first_line = "*GREENBEAN ECOTYPE COEFFICIENTS: CRGRO048 MODEL", comments = c("", 

structure(list(`ECO#` = "G00001", ECONAME = "Brachiaria", MG = "00", 
    TM = "01", THVAR = 1, `PL-EM` = 0, `EM-V1` = 0, `V1-JU` = 0, 
...
RCHDP = "%6.0f"), first_line = "*BRACHIARIA ECOTYPE COEFFICIENTS: PRFRM048 MODEL", comments = c(" Marandu - Diego Pequeno", 

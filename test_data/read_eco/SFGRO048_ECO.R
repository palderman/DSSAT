...
), MG = c("04", "04", "04", "04"), TM = c("01", "01", "01", "01"
), THVAR = c(0, 0, 0, 0), `PL-EM` = c(5, 5, 5, 5), `EM-V1` = c(6, 
6, 3, 3), `V1-JU` = c(0, 0, 0, 0), `JU-R0` = c("05.0", "05.0", 
"05.0", "05.0"), PM06 = c(0, 0, 0, 0), PM09 = c(0.35, 0.35, 0.35, 
0.35), LNGSH = c(10, 10, 10, 10), `R7-R8` = c(26, 26, 26, 26), 
    `FL-VS` = c(7, 7, 14, 14), TRIFL = c(1, 1, 1, 1), RWDTH = c(0.75, 
    0.75, 0.75, 1), RHGHT = c(0.75, 0.75, 0.8, 1), R1PPO = c(0.369, 
    0.369, 0.369, 0.369), OPTBI = c(20, 20, 20, 20), SLOBI = c(0.035, 
    0.035, 0.035, 0.035)), class = c("DSSAT_tbl", "tbl_df", "tbl", 
"data.frame"), row.names = c(NA, -4L), v_fmt = c(`ECO#` = "%-7s", 
...
TRIFL = "%6.0f", RWDTH = "%6.2f", RHGHT = "%6.2f", R1PPO = "%6.3f", 
OPTBI = "%6.0f", SLOBI = "%6.3f"), first_line = "*SAFFLOWER ECOTYPE COEFFICIENTS: CRGRO048 MODEL", comments = c("", 

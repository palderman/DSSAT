structure(list(`ECO#` = "GG0009", ECONAME = "Panicum", MG = "00", 
    ...
    OPTBI = 0, SLOBI = 0, RDRMT = 0.35, RDRMG = 1, RDRMM = 0.574, 
...
SLOBI = "%6.0f", RDRMT = "%6.2f", RDRMG = "%6.0f", RDRMM = "%6.3f", 
RCHDP = "%6.0f"), first_line = "*GUINEAGRASS ECOTYPE COEFFICIENTS (27)                                                                                                                                                                        ", comments = c("Guineagrass - Panicum maximum", 

...
"SY0002", "US0001"), P1 = c(100, 500, 200, 381, 394, 356), P2FR1 = c(0, 
0.6, 0.25, 0.25, 0.25, 0.25), P2 = c(100, 500, 200, 285, 294, 
265), P3 = c(100, 500, 200, 191, 198, 179), P4FR1 = c(0.15, 0.35, 
0.25, 0.25, 0.25, 0.25), P4FR2 = c(0.05, 0.25, 0.1, 0.1, 0.1, 
0.1), P4 = c(100, 500, 200, 258, 267, 241), VEFF = c(0, 1, 0.6, 
0.3, 0.3, 1), PARUE = c(1, 6, 2.7, 2, 2, 2.6), PARU2 = c(1, 6, 
2.7, 2, 2, 2.6), PHL2 = c(4, 200, 15, 13, 13, 13), PHF3 = c(1, 
1.6, 1.3, 1, 1, 1), LA1S = c(1, 20, 5, 4, 4, 4.8), LAFV = c(0.01, 
0.8, 0.1, 0.1, 0.1, 0.05), LAFR = c(0.1, 3, 0.5, 0.3, 0.3, 0.13
), SLAS = c(100, 600, 400, 300, 300, 400), LSPHS = c(4, 5.7, 
5.5, 4.2, 4.2, 5.3), LSPHE = c(5.5, 6.5, 6.3, 6, 6, 6.5), `TIL#S` = c(2.5, 
7, 3.5, 5, 5, 4.5), TIPHE = c(2, 4, 2.5, 2.5, 2.5, 2), TIFAC = c(0.5, 
2, 1, 1, 1, 1), TDPHS = c(1.5, 4, 2.5, 2.5, 2.5, 2), TDPHE = c(2, 
6, 6, 5, 5, 4), TDFAC = c(0, 20, 4, 1, 1, 0.1), RDGS = c(1, 5, 
3, 3, 3, 3), HTSTD = c(60, 150, 100, 100, 100, 100), AWNS = c(0, 
10, 0, 0, 0, 5), KCAN = c(0.65, 0.95, 0.85, 0.85, 0.85, 0.85), 
    `RS%S` = c(10, 60, 30, 30, 30, 30), `GN%S` = c(1, 3.5, 3, 
    3, 3, 2), `GN%MN` = c(0, 6, 0, 0, 0, 0), TKFH = c(-10, -25, 
    -10, -10, -10, -20)), class = c("DSSAT_tbl", "tbl_df", "tbl", 
"data.frame"), row.names = c(NA, -6L), v_fmt = c(`ECO#` = "%-6s", 

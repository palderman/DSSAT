...
"MG 4 Africa"), MG = c("07", "04", "04", "04", "04", "04", "04"
), TM = c("01", "01", "01", "01", "01", "01", "01"), `PP-SS` = c(0, 
0, 0, 0, 0, 0, 0), `PL-EM` = c(3.6, 3.6, 3.5, 3.5, 3.5, 3.5, 
3.5), `EM-V1` = c(6, 6, 6, 6, 6, 6, 6), `V1-JU` = c(0, 0, 0, 
0, 0, 0, 0), `JU-R0` = c("05.0", "05.0", "05.0", "05.0", "05.0", 
"10.0", "05.0"), PM06 = c(0, 0, 0, 0, 0, 0, 0), PM09 = c(0.35, 
0.35, 1.35, 0.35, 0.35, 0.35, 0.35), LNHSH = c(10, 6.5, 6.5, 
6.5, 6.5, 6.5, 6.5), `R7-R8` = c(12, 7, 7, 7, 7, 7, 7), `FL-VS` = c("9.00", 
"08.00", "26.00", "10.00", "26.00", "10.00", "10.00"), TRIFL = c(0.32, 
0.45, 0.4, 0.4, 0.4, 0.4, 0.45), RWDTH = c(1, 1, 1, 1, 1, 1, 
1), RHGHT = c(0.9, 1, 1, 1, 1, 1, 1), R1PPO = c(0.504, 0.369, 
0.369, 0.369, 0.369, 0.369, 0.369), OPTBI = c(20, 17, 17, 17, 
17, 17, 17), SLOBI = c(0.035, 0, 0, 0, 0, 0, 0)), class = c("DSSAT_tbl", 
...
`FL-VS` = "%6s", TRIFL = "%6.2f", RWDTH = "%6.0f", RHGHT = "%6.1f", 
R1PPO = "%6.3f", OPTBI = "%6.0f", SLOBI = "%6.3f"), first_line = "*COWPEA ECOTYPE COEFFICIENTS: CRGRO048 MODEL", comments = c("", 

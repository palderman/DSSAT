...
"DEFAULT TYPE"), MG = c(4L, 4L, 4L, 4L), TM = c(1L, 1L, 1L, 1L
), `PP-SS` = c(0, 0, 0, 0), `PL-EM` = c(3.6, 3.6, 3.6, 3.6), 
    `EM-V1` = c(6, 6, 6, 6), `V1-JU` = c(0, 0, 0, 0), `JU-R0` = c(5, 
    5, 5, 5), PM06 = c(0, 0, 0, 0), PM09 = c(0.35, 0.35, 0.35, 
    0.35), LNHSH = c(25, 25, 25, 25), `R7-R8` = c(12, 12, 12, 
    12), `FL-VS` = c(35, 39, 23, 39), TRIFL = c(0.38, 0.38, 0.45, 
    0.38), RWDTH = c(1, 1, 1.8, 1), RHGHT = c(1, 1, 1.2, 1), 
    R1PPO = c(0, 0, 0, 0), OPTBI = c(20, 20, 20, 20), SLOBI = c(0.035, 

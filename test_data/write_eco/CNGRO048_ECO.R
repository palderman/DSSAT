...
0), `JU-R0` = c(5, 5), PM06 = c(0, 0), PM09 = c(0.35, 0.35), 
    LNGSH = c(10, 10), `R7-R8` = c(3, 12), `FL-VS` = c(0, 0), 
    TRIFL = c(0.35, 0.32), RWDTH = c(1, 1), RHGHT = c(1.5, 0.9
    ), R1PPO = c(0, 0.504), OPTBI = c(0, 20), SLOBI = c(0, 0.035
    )), class = c("DSSAT_tbl", "tbl_df", "tbl", "data.frame"), row.names = c(NA, 
-2L), v_fmt = c(`ECO#` = "%-7s", ECONAME = "%-18s", MG = "%2.0f", 
TM = "%3.0f", THVAR = "%6.0f", `PL-EM` = "%6.1f", `EM-V1` = "%6.0f", 
`V1-JU` = "%6.0f", `JU-R0` = "%6.0f", PM06 = "%6.0f", PM09 = "%6.2f", 
LNGSH = "%6.0f", `R7-R8` = "%6.0f", `FL-VS` = "%6.0f", TRIFL = "%6.2f", 
RWDTH = "%6.0f", RHGHT = "%6.1f", R1PPO = "%6.3f", OPTBI = "%6.0f", 

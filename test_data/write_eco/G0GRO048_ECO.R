structure(list(`ECO#` = "G00001", ECONAME = "PENSACOLA BAHIA", 
    MG = 0L, TM = 1L, THVAR = 1, `PL-EM` = 0, `EM-V1` = 0, `V1-JU` = 9999, 
    `JU-R0` = 9999, PM06 = 0, PM09 = 0.75, LNGSH = 10, `R7-R8` = 9999, 
    `FL-VS` = 9999, TRIFL = 0.15, RWDTH = 1, RHGHT = 1, THRSH = 78, 
    SDPRO = 0.115, SDLIP = 0.035, R1PPO = 0, OPTBI = 0, SLOBI = 0), class = c("DSSAT_tbl", 
...
THRSH = "%6.0f", SDPRO = "%6.3f", SDLIP = "%6.3f", R1PPO = "%6.0f", 

...
"KABULI TYPE", "DEFAULT"), MG = c(1L, 1L, 1L), TM = c(1L, 1L, 
1L), THVAR = c(0, 0, 0), `PL-EM` = c(2, 2, 2), `EM-V1` = c(1.5, 
1.5, 1.5), `V1-JU` = c(0, 0, 0), `JU-R0` = c(5, 5, 5), PM06 = c(0, 
0, 0), PM09 = c(0.2, 0.2, 0.2), LNGSH = c(7, 7, 7), `R7-R8` = c(8, 
8, 8), `FL-VS` = c(19, 19, 19), TRIFL = c(0.6, 0.6, 0.6), RWDTH = c(1, 
1, 1), RHGHT = c(1, 1, 1), R1PPO = c(0, 0, 0), OPTBI = c(0, 0, 
0), SLOBI = c(0, 0, 0)), class = c("DSSAT_tbl", "tbl_df", "tbl", 
"data.frame"), row.names = c(NA, -3L), v_fmt = c(`ECO#` = "%-7s", 
ECONAME = "%-18s", MG = "%2.0f", TM = "%3.0f", THVAR = "%6.0f", 
`PL-EM` = "%6.0f", `EM-V1` = "%6.1f", `V1-JU` = "%6.0f", `JU-R0` = "%6.0f", 
PM06 = "%6.0f", PM09 = "%6.1f", LNGSH = "%6.0f", `R7-R8` = "%6.0f", 
`FL-VS` = "%6.0f", TRIFL = "%6.1f", RWDTH = "%6.0f", RHGHT = "%6.0f", 
R1PPO = "%6.0f", OPTBI = "%6.0f", SLOBI = "%6.0f"), first_line = "*CHICKPEA ECOTYPE COEFFICIENTS: CRGRO048 MODEL", comments = c("", 

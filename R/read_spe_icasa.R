#' Reads input data from a single DSSAT ICASA compliant species file (*.SPE)
#'
#' @export
#'
#' @keywords internal
...
read_spe_icasa <- function(file_name,col_types=NULL,col_names=NULL,left_justified=NULL){
